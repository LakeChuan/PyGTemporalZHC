...
def process_single_rain_folder(folder_path, grid_size=80):
    ...
    # 5. 拼接通道 → 最终 shape = (T, H, W, C)
    # C=2：通道0=降雨，通道1=水深
    combined_feature = np.stack([rain_feature, depth_data], axis=-1)
...
def main():
    # ====================== 根目录配置（直接用你当前的路径） ======================
    root_rain_dir = r"E:\Coding\Pytorch\PyGTemporalZHC\HCGNN\data\val\loaction1\dynamic\rain"
    grid_size = 80
    # =========================================================================
